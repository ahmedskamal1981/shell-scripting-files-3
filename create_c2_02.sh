...
create_ec2_instance() {
    local ami_id="ami-020cba7c55df1f615"
    local instance_type="t2.micro"
    local key_name="aws-cli-shell-scripting-01"
    local subnet_id="subnet-03d88014601a00408"
    local security_group_ids="sg-01bc7d7a85ecb2894"
